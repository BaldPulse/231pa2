...
describe('traverseExpr(c, s) function', function () {
    it('parses a number in the beginning', function () {
        ...
        // go to expression
        cursor.firstChild();
        var parsedExpr = parser_1.traverseExpr(source, cursor);
        // Note: we have to use deep equality when comparing objects
        chai_1.expect(parsedExpr).to.deep.equal({ tag: "number", value: 987 });
    });
...
describe('parseProgram(source) function', function () {
