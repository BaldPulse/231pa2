...
describe('run(source, config) function', function () {
    ...
    it('typedef int', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('typedef bool', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, runTest("x:int = False\nprint(x)")];
                case 1:
                    _a.sent();
